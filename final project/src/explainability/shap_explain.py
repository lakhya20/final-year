...
model = joblib.load("../models/svm_calibrated_model.pkl")  # trained with 5000 features
vectorizer = joblib.load("../models/svm_tfidf_vectorizer.pkl")  # trained vectorizer
...
shap.save_html("svm_shap_explanation.html", viz)
