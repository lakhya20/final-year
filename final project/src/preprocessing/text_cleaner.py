...
if __name__ == "__main__":
    ...
    preprocessor.preprocess_dataset(
        input_path="D:/FINAL YEAR PROJECT/iris_project/data/raw/inflation_dataset.json",
        output_path="D:/FINAL YEAR PROJECT/iris_project/data/processed/cleaned_inflation_dataset.csv"
